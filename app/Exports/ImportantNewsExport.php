...
class ImportantNewsExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    public function collection()
    {
        ...
        $news = News::join('details','details.news_id','=','news.id')
            ->select('news.title as title','news.created_at as created_at','news.text as text','details.important as important',
